...
/*this is delet quer*/
mysqli_query($connection,"delete from admin where user_id='$user_id'")or die("query is incorrect...");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<?php 
$result=mysqli_query($connection,"select user_id,name,email,password from admin")or die ("query 2 incorrect.......");

while(list($user_id,$name,$email,$password)=
