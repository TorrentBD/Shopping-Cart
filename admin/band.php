...
$result=mysqli_query($connection,"select product_image, product_title,product_cat,product_price from products where product_cat='3' Limit $page1,10")or die ("query 1 incorrect.....");
